...
pub const RPL_ENDOFPROPLIST: u16 = 960; // PROP (named modes) list terminator
pub const RPL_PROPLIST: u16 = 961; // PROP (named modes) list entry
...
pub const ERR_YOUREBANNEDCREEP: u16 = 465; // refused: banned (K/G/Z/R-line, DNSBL)
...
pub const RPL_WHOISACTUALLY: u16 = 338; // oper/self: the real ip a cloaked user connects from
...
pub const ERR_TARGETTOOFAST: u16 = 439; // target-change throttle
pub const ERR_NORECIPIENT: u16 = 411;
pub const ERR_NOTEXTTOSEND: u16 = 412;
pub const ERR_INPUTTOOLONG: u16 = 417; // a line exceeded the max length and was dropped
...
pub const ERR_NOPRIVS: u16 = 723; // oper lacks the fine-grained privilege/command
